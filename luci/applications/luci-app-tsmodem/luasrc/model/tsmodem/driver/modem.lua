...
require "luci.model.tsmodem.driver.util"
...
local stm = require "luci.model.tsmodem.driver.stm"
local timer = require "luci.model.tsmodem.driver.timer"
local state = require "luci.model.tsmodem.driver.state"
